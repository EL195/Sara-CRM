<?php
/* Smarty version 3.1.39, created on 2021-03-30 20:07:47
  from '/Users/razib/Documents/valet/business-suite/ui/theme/default/localisation.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_6063bd53252f45_84729157',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '017db1883d5870b151c90ebd5d7122f17a6cf11d' => 
    array (
      0 => '/Users/razib/Documents/valet/business-suite/ui/theme/default/localisation.tpl',
      1 => 1613565767,
      2 => 'file',
    ),
  ),
...
function content_6063bd53252f45_84729157 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_7664334756063bd531c4c19_62780627', "content");
?>


<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_20974362106063bd53252641_97364790', "script");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, ((string)$_smarty_tpl->tpl_vars['layouts_admin']->value));
}
/* {block "content"} */
class Block_7664334756063bd531c4c19_62780627 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_7664334756063bd531c4c19_62780627',
  ),
);
...
?>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="panel">
                <div class="panel-hdr">
                    <h2><?php echo $_smarty_tpl->tpl_vars['_L']->value['Localisation'];?>
</h2>
...
">
                            ...
                            <div class="form-group">
                                <label for="currency_decimal_digits"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Pads the decimal with zeros'];?>
</label>
                                <select class="form-control" name="currency_decimal_digits" id="currency_decimal_digits">

                                    <option value="false" <?php if (($_smarty_tpl->tpl_vars['config']->value['currency_decimal_digits'] == 'false')) {?> selected="selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['No'];?>
</option>
                                    <option value="true" <?php if (($_smarty_tpl->tpl_vars['config']->value['currency_decimal_digits'] == 'true')) {?> selected="selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['_L']->value['Yes'];?>
</option>
                            ...
                            <div class="my-3">
                                <strong><?php echo $_smarty_tpl->tpl_vars['_L']->value['Decimal Places'];?>
</strong>
                            </div>

                            <div class="form-group">
                                <label for="decimal_places_products_and_services"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Products n Services'];?>
</label>
                                <select class="form-control" id="decimal_places_products_and_services" name="decimal_places_products_and_services">
                                    <option value="default"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Default'];?>
</option>
                                    <option value="0" <?php if ((isset($_smarty_tpl->tpl_vars['config']->value['decimal_places_products_and_services'])) && $_smarty_tpl->tpl_vars['config']->value['decimal_places_products_and_services'] == 0) {?> selected<?php }?>>0</option>
                                    <option value="1" <?php if ((isset($_smarty_tpl->tpl_vars['config']->value['decimal_places_products_and_services'])) && $_smarty_tpl->tpl_vars['config']->value['decimal_places_products_and_services'] == 1) {?> selected<?php }?>>1</option>
                                    <option value="2" <?php if ((isset($_smarty_tpl->tpl_vars['config']->value['decimal_places_products_and_services'])) && $_smarty_tpl->tpl_vars['config']->value['decimal_places_products_and_services'] == 2) {?> selected<?php }?>>2</option>
                                    <option value="3" <?php if ((isset($_smarty_tpl->tpl_vars['config']->value['decimal_places_products_and_services'])) && $_smarty_tpl->tpl_vars['config']->value['decimal_places_products_and_services'] == 3) {?> selected<?php }?>>3</option>
                                    <option value="4" <?php if ((isset($_smarty_tpl->tpl_vars['config']->value['decimal_places_products_and_services'])) && $_smarty_tpl->tpl_vars['config']->value['decimal_places_products_and_services'] == 4) {?> selected<?php }?>>4</option>
                                    <option value="5" <?php if ((isset($_smarty_tpl->tpl_vars['config']->value['decimal_places_products_and_services'])) && $_smarty_tpl->tpl_vars['config']->value['decimal_places_products_and_services'] == 5) {?> selected<?php }?>>5</option>
                                </select>
                            </div>
...
/* {/block "content"} */
/* {block "script"} */
class Block_20974362106063bd53252641_97364790 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'script' => 
  array (
    0 => 'Block_20974362106063bd53252641_97364790',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
