<?php
/* Smarty version 3.1.39, created on 2021-04-09 12:52:57
  from '/Users/razib/Documents/valet/business-suite/ui/theme/frontend/agency_default/layout.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_60708669cff5e5_08358971',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b9807d0b685a5957a4c0b96c6aeb32224474aa91' => 
    array (
      0 => '/Users/razib/Documents/valet/business-suite/ui/theme/frontend/agency_default/layout.tpl',
      1 => 1617986773,
      2 => 'file',
    ),
  ),
...
function content_60708669cff5e5_08358971 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!doctype html>
<html lang="en">
<head>
...
<header class="header header-sticky header-light">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a href="index.html" class="navbar-brand mr-8"><img src="assets/images/logo-black.svg" alt="Logo"></a>
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown dropdown-hover">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown-1">
                            ...
                            <a class="dropdown-item active" href="saas.html">Saas</a>
                            ...
                            <a class="dropdown-item" href="index.html">Presentation</a>
                    ...
                    <li class="nav-item dropdown dropdown-hover">
                        ...
                        <div class="dropdown-menu dropdown-menu-md" aria-labelledby="navbarDropdown-2">
                            <div class="row">
                                <div class="col">
                    ...
                    <li class="nav-item dropdown dropdown-hover">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown-3">
                            <a class="dropdown-item" href="docs/index.html">Get Started</a>
                            <a class="dropdown-item" href="docs/c-alerts.html">Components</a>
                            <a class="dropdown-item" href="docs/s-applications.html">Sections</a>
                        </div>
                    </li>
                </ul>
                <a href="" class="action underline text-black ml-auto">Buy Now <i class="icon-arrow-up-right"></i></a>
            </div>
        </nav>
    </div>
</header>
    ...
    <div class="container foreground">
        <div class="row align-items-center justify-content-center justify-content-lg-between vh-100">
            ...
            <div class="col-md-10 col-lg-6 pr-lg-6 text-center text-lg-left">
                <h1 class="font-weight-bold">A better workflow for your company</h1>
                ...
                <a class="btn btn-black btn-rounded btn-with-icon mt-2" href="">
                    <i class="icon-arrow-up-right"></i> Get Started
                </a>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center justify-content-lg-between">
            ...
            <div class="col-lg-6 text-center text-lg-left">
                <h2 class="font-weight-bold">Start getting bigger numbers today</h2>
...
<section class="cover overflow-hidden">
    ...
    <figure class="image image-scroll" style="background-image: url('assets/images/saas-1.jpg')"
...
<section class="pt-0">
    <div class="container">
        <div class="row justify-content-between align-items-center gutter-3 gutter-lg-5">
            <div class="col-lg-5">
                <h2 class="font-weight-bold">Start writing clean and optimized code.</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa quos magni quisquam fuga quidem sapiente architecto, error eligendi fugiat sequi repellendus dolorum numquam distinctio, officiis.</p>
            </div>
            <div class="col-lg-6">
                <div class="browser text-white">
                    <span></span>
...
<footer class="border-top">
    <div class="container">
        <div class="row justify-content-between gutter-2 gutter-lg-6">
            <div class="col-lg-4">
                <a href="index.html" class="navbar-brand"><img src="assets/images/logo-black.svg" alt="Logo"></a>
