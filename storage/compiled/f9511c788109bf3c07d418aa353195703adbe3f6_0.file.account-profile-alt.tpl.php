<?php
/* Smarty version 3.1.39, created on 2021-08-14 18:01:52
  from '/Users/razib/Documents/valet/business-suite/ui/theme/default/account-profile-alt.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_61183d506e5f36_17358276',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f9511c788109bf3c07d418aa353195703adbe3f6' => 
    array (
      0 => '/Users/razib/Documents/valet/business-suite/ui/theme/default/account-profile-alt.tpl',
      1 => 1628978509,
      2 => 'file',
    ),
  ),
...
function content_61183d506e5f36_17358276 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_62465607561183d506be4c1_09350566', "head");
?>



<?php $_smarty_tpl->_assignInScope('page_content_extra_class', "p-0");?>

<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_104125890861183d506c2230_36691811', "content");
?>


<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_136325178261183d506d8882_35226799', "script");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, ((string)$_smarty_tpl->tpl_vars['layouts_admin']->value));
}
/* {block "head"} */
class Block_62465607561183d506be4c1_09350566 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'head' => 
  array (
    0 => 'Block_62465607561183d506be4c1_09350566',
  ),
);
...
/* {/block "head"} */
/* {block "content"} */
class Block_104125890861183d506c2230_36691811 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_104125890861183d506c2230_36691811',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
?s=400" class="img-fluid" alt="<?php echo $_smarty_tpl->tpl_vars['d']->value['fname'];?>
...
" class="img-fluid rounded-circle" alt="<?php echo $_smarty_tpl->tpl_vars['d']->value['account'];?>
">
                        <?php }?>

                        <div class="mt-3">
                            <?php if ($_smarty_tpl->tpl_vars['d']->value['email'] != '') {?>
                                <h5 class="text-muted" style="overflow-wrap: break-word;"><?php echo $_smarty_tpl->tpl_vars['d']->value['email'];?>
</h5>
                            <?php }?>
                            <?php if ($_smarty_tpl->tpl_vars['d']->value['phone'] != '') {?>
                                <h5 class="text-muted" style="overflow-wrap: break-word;"><?php echo $_smarty_tpl->tpl_vars['d']->value['phone'];?>
</h5>
                            <?php }?>
                        </div>
                    ...
                    <div class="pr-3">
                        ...
                        <a href="javascript:;" id="summary" class="dropdown-item clx-side-menu-item px-3 px-sm-4 pr-lg-3 pl-lg-5 py-2 fs-md d-flex justify-content-between rounded-pill border-top-left-radius-0 border-bottom-left-radius-0 active">
                            <div class="svg-icon svg-icon-primary">
                                ...
                                </i><?php echo $_smarty_tpl->tpl_vars['_L']->value['Summary'];?>
                        ...
                        <a href="javascript:;" id="activity" class="dropdown-item clx-side-menu-item px-3 px-sm-4 pr-lg-3 pl-lg-5 py-2 fs-md d-flex justify-content-between rounded-pill border-top-left-radius-0 border-bottom-left-radius-0 active">
                            <div class="svg-icon svg-icon-primary">
                                ...
                                </i><?php echo $_smarty_tpl->tpl_vars['_L']->value['Activity'];?>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['is_supplier']->value && has_access($_smarty_tpl->tpl_vars['user']->value->roleid,'suppliers') && ($_smarty_tpl->tpl_vars['config']->value['purchase'])) {?>
                            ...
                            <a href="javascript:void(0);" id="purchases" class="dropdown-item clx-side-menu-item px-3 px-sm-4 pr-lg-3 pl-lg-5 py-2 fs-md d-flex justify-content-between rounded-pill border-top-left-radius-0 border-bottom-left-radius-0">
                                <div>
                                    ...
                                    </i><?php echo $_smarty_tpl->tpl_vars['_L']->value['Purchase Orders'];?>

                                </div>
                                <div class="fw-400 fs-xs">(<?php echo $_smarty_tpl->tpl_vars['po_count']->value;?>
)</div>
                            </a>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['config']->value['invoicing'] == '1') {?>
                            ...
                            <a href="javascript:void(0)" id="invoices" class="dropdown-item clx-side-menu-item px-3 px-sm-4 pr-lg-3 pl-lg-5 py-2 fs-md d-flex justify-content-between rounded-pill border-top-left-radius-0 border-bottom-left-radius-0">
                               ...
                               <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                ...
                                <div class="fw-400 fs-xs">(<?php echo $_smarty_tpl->tpl_vars['inv_count']->value;?>
)</div>
                            </a>
                            ...
                            <a href="javascript:void(0)" id="quotes" class="dropdown-item clx-side-menu-item px-3 px-sm-4 pr-lg-3 pl-lg-5 py-2 fs-md d-flex justify-content-between rounded-pill border-top-left-radius-0 border-bottom-left-radius-0">
                                <div class="svg-icon svg-icon-primary">
                                  ...
                                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    ...
                                    <?php echo $_smarty_tpl->tpl_vars['_L']->value['Quotes'];?>

                                </div>
                                <div class="fw-400 fs-xs">(<?php echo $_smarty_tpl->tpl_vars['quote_count']->value;?>
)</div>
                            </a>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['config']->value['documents'] == '1') {?>
                            ...
                            <a href="javascript:void(0)" id="files" class="dropdown-item clx-side-menu-item px-3 px-sm-4 pr-lg-3 pl-lg-5 py-2 fs-md d-flex justify-content-between rounded-pill border-top-left-radius-0 border-bottom-left-radius-0">
                                <div class="svg-icon svg-icon-primary">
                                    ...
                                    </i><?php echo $_smarty_tpl->tpl_vars['_L']->value['Files'];?>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['config']->value['accounting'] == '1') {?>
                            ...
                            <a href="javascript:void(0)" id="transactions" class="dropdown-item clx-side-menu-item px-3 px-sm-4 pr-lg-3 pl-lg-5 py-2 fs-md d-flex justify-content-between rounded-pill border-top-left-radius-0 border-bottom-left-radius-0">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    ...
                                    </i><?php echo $_smarty_tpl->tpl_vars['_L']->value['Transactions'];?>
                        ...
                        <a href="javascript:void(0)" id="log" class="dropdown-item clx-side-menu-item px-3 px-sm-4 pr-lg-3 pl-lg-5 py-2 fs-md d-flex justify-content-between rounded-pill border-top-left-radius-0 border-bottom-left-radius-0">
                            <div class="svg-icon svg-icon-primary">
                                ...
                                </i><?php echo $_smarty_tpl->tpl_vars['_L']->value['Log'];?>
                        ...
                        <?php if (($_smarty_tpl->tpl_vars['config']->value['password_manager']) && has_access($_smarty_tpl->tpl_vars['user']->value->roleid,'password_manager')) {?>
                           ...
                           <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    ...
                                    <?php echo $_smarty_tpl->tpl_vars['_L']->value['Password Manager'];?>
                        ...
                        <a href="javascript:void(0)" id="credit_card_info" class="dropdown-item clx-side-menu-item px-3 px-sm-4 pr-lg-3 pl-lg-5 py-2 fs-md d-flex justify-content-between rounded-pill border-top-left-radius-0 border-bottom-left-radius-0">
                            <div class="svg-icon svg-icon-primary">
                                ...
                                <?php echo $_smarty_tpl->tpl_vars['_L']->value['Credit Card Information'];?>
                        ...
                        <a href="javascript:void(0)" id="more" class="dropdown-item clx-side-menu-item px-3 px-sm-4 pr-lg-3 pl-lg-5 py-2 fs-md d-flex justify-content-between rounded-pill border-top-left-radius-0 border-bottom-left-radius-0">
                            <div class="svg-icon svg-icon-primary">
                                ...
                                <?php echo $_smarty_tpl->tpl_vars['_L']->value['More'];?>
...
/* {/block "content"} */
/* {block "script"} */
class Block_136325178261183d506d8882_35226799 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'script' => 
  array (
    0 => 'Block_136325178261183d506d8882_35226799',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
',
            ...
            sysrender.on('change', '#contact_note', function(){
                ...
                $.post(_url + 'contacts/edit-notes/', {
                    ...
                    cid: '<?php echo $_smarty_tpl->tpl_vars['d']->value['id'];?>
',
...
');
                ...
                $.post(base_url + 'contacts/set-boolean/', {
                    ...
                    contact_id: '<?php echo $_smarty_tpl->tpl_vars['d']->value['id'];?>
',
...
"
            ...
            $modal.on('click', '.eml_select', function(e) {
                ...
                $.getJSON(base_url + "handler/json_eml_tpl/"+eml_id + '/' + <?php echo $_smarty_tpl->tpl_vars['contact']->value->id;?>
, function (data) {
